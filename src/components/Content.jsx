...
const Content = ({messages, currentUser}) => {
    ...
    const handleSendMessage = () => {
        FirebaseApi.sendMessage(message, currentUser).then(() => setMessage(""))
    };
    ...
    return <div className="content">
        ...
        <div className="messages">
            <ul>
               ...
               {/* <p>How the hell am I supposed to get a jury to believe you when I am not even sure thatI do?!</p>*/}
               {/*</li>*/}
